...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkedColor = optColorStateList(typedArray,
                R.styleable.SwitchButton_sb_checked_color);//0Xff51d367;
    ...
    private void setCheckedViewState(ViewState viewState) {
        ...
        viewState.checkStateColor = checkedColor.getColorForState(isEnabled() ? new int[]{android.R.attr.state_enabled} : new int[]{-android.R.attr.state_enabled}, checkedColor.getDefaultColor());
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (isPendingDragState()) {
                    ...
                    viewState.checkStateColor = (int) argbEvaluator.evaluate(
                            fraction,
                            uncheckColor,
                            checkedColor.getColorForState(isEnabled() ? new int[]{android.R.attr.state_enabled} : new int[]{-android.R.attr.state_enabled}, checkedColor.getDefaultColor())
                    );
                    postInvalidate();
    ...
    private void pendingDragState() {
        ...
        if (isChecked()) {
            afterState.checkStateColor = checkedColor.getColorForState(isEnabled() ? new int[]{android.R.attr.state_enabled} : new int[]{-android.R.attr.state_enabled}, checkedColor.getDefaultColor());
            afterState.buttonX = buttonMaxX;
            afterState.checkedLineColor = checkedColor.getColorForState(isEnabled() ? new int[]{android.R.attr.state_enabled} : new int[]{-android.R.attr.state_enabled}, checkedColor.getDefaultColor());
        } else {
    ...
    private static ColorStateList optColorStateList(TypedArray typedArray,
                                                    int index) {
            ...
            switch (animateState) {
                ...
                case ANIMATE_STATE_SWITCH: {
                    ...
                    viewState.checkStateColor = (int) argbEvaluator.evaluate(
                            fraction,
                            uncheckColor,
                            checkedColor.getColorForState(isEnabled() ? new int[]{android.R.attr.state_enabled} : new int[]{}, checkedColor.getDefaultColor())
                    );
